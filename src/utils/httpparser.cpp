...
HttpParser::request_parser_type & operator ++ ( HttpParser::request_parser_type & t ) {
	switch ( t ) {
...
HttpParser::response_parser_type & operator ++ ( HttpParser::response_parser_type & t ) {
	switch ( t ) {
...
size_t HttpParser::parse_request_status_line ( RequestParserState & parser_state, http::HttpRequest & request, buffer_t & buffer, size_t start, size_t end ) {
...
size_t HttpParser::parse_response_status_line ( RequestParserState & parser_state, http::HttpResponse & response, buffer_t & buffer, size_t start, size_t end ) {
	parser_state.start_pos_ = start;
...
size_t HttpParser::parse_parameter ( RequestParserState & parser_state, http::HttpRequest & request, buffer_t & buffer, size_t start, size_t end ) {
	parser_state.start_pos_ = start;
...
size_t HttpParser::parse_parameter ( RequestParserState & parser_state, http::HttpResponse & response, buffer_t & buffer, size_t start, size_t end ) {
	parser_state.start_pos_ = start;
...
size_t HttpParser::parse_body_form_data ( RequestParserState & parser_state, http::HttpRequest & request, buffer_t & buffer, size_t start, size_t end ) {
...
size_t HttpParser::parse_request ( HttpRequest & request, buffer_t & buffer, size_t start, size_t end ) {
...
size_t HttpParser::parse_response ( HttpResponse & response, buffer_t & buffer, size_t start, size_t end ) {
	size_t _position = start;
 ...
 */
void HttpParser::get_attributes ( const std::string & parameters, HttpRequest & request ) {
