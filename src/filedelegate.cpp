...
void FileDelegate::execute ( HttpRequest & request, HttpResponse & response ) {
...
void FileDelegate::get ( HttpRequest & request, HttpResponse & response, const std::string & filename, const size_t file_size ) {
